              ...
              <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="space-y-6">
                  <div className="flex items-center space-x-3">
                    ...
                    <h3 className="text-xl font-semibold text-crimson">Before</h3>
                  </div>
                  <div className="bg-slate-900/50 p-6 rounded-xl border border-slate-700/30 relative">
                ...
                <div className="space-y-6">
                  <div className="flex items-center space-x-3">
                    ...
                    <h3 className="text-xl font-semibold text-lime-green">After</h3>
                  </div>
                  <div className="bg-slate-900/50 p-6 rounded-xl border border-lime-green/30 relative">
                    <div className="absolute top-4 right-4 text-lime-green text-sm font-medium">Optimized Prompt</div>
                    <p className="text-slate-300 text-lg leading-relaxed">
